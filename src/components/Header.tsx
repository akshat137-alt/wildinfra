...
const navLinks = [
  { href: "#problem", label: "Why WildInfra" },
...
export function Header() {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-white/[0.08] bg-[#09090b]/90 backdrop-blur-md">
      <div className="mx-auto flex h-14 w-full max-w-6xl items-center justify-between px-5 sm:px-8">
        ...
        <div className="hidden items-center gap-4 md:flex">
          ...
          <Link
            href="/contact"
            className="inline-flex h-8 items-center justify-center rounded-md bg-white px-3.5 text-xs font-semibold text-black transition-colors hover:bg-zinc-200"
          >
            Get API Key
          </Link>
        </div>
      ...
      {open && (
        <nav className="border-b border-white/[0.08] bg-[#09090b] px-5 py-4 md:hidden">
          <div className="flex flex-col gap-3">
            ...
            <div className="mt-3 border-t border-white/[0.08] pt-3">
              <Link
                href="/contact"
                className="block w-full rounded-md bg-white py-2 text-center text-xs font-semibold text-black"
                onClick={() => setOpen(false)}
              >
                Get API Key
              </Link>
